...
sudo sed -i "s/NGINX_FPM_BACKEND_HOST/${NGINX_FPM_BACKEND_HOST}/g" /etc/nginx/sites/locations/cake.conf
sudo sed -i "s/NGINX_FPM_BACKEND_PORT/${NGINX_FPM_BACKEND_PORT}/g" /etc/nginx/sites/locations/cake.conf